...
const printOuterNumsFirst = require("../problems/04-print-outer-nums-first.js");
...
describe("printOuterNumsFirst()", function() {
  ...
  it("should print the outermost numbers first starting at the end number for an even amount of numbers", function() {
  ...
  it("should print the outermost numbers first starting with the beginning number for an odd amount of numbers", function() {
    let setConsoleLogSpy = chai.spy.on(console, "log");
